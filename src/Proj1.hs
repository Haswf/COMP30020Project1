...
--  Description : Haskell code to implement a two-player logical guessing game.
--  One player will be the answerer and the other is the guesser. The answerer
--  starts by selecting some number of cards from his or her deck withouing 
--  showing the guesser. The guesser need to chooses the same amount of cards.
--  The answerer reponds by telling the guesser 5 numbers as feedback for the 
--  guess. At each turn, feedback function is called to evaulate a guess to
--  produce feedback. Then, nextGuess is called to generate new guess with 
--  feedback of the previous guess.
